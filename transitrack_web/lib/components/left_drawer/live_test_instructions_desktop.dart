...
class LiveTestInstructionsDesktop extends StatelessWidget {
  const LiveTestInstructionsDesktop({super.key});
        ...
        RichText(
          text: const TextSpan(
            children: [
              ...
              TextSpan(
                text: "In the menu, you will see the different routes. Select ",
                style: TextStyle(
                  color: Colors.white,
                ),
              ),
        ...
        RichText(
          text: const TextSpan(
            children: [
              ...
              TextSpan(
                text:
                    "In the map section, tap on any PUV. You will see relevant information at the top right part of the screen like driver, plate number, etc.",
                style: TextStyle(
                  color: Colors.white,
                ),
              ),
