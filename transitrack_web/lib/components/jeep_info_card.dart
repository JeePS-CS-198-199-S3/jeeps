        ...
        children: [
          ...
          Expanded(
              child: Column(
                ...
                children: [
                  Text(data.slots_remaining <= 0?("Full"):(data.passenger_count==0?"Empty":"${data.slots_remaining} $slots left"), maxLines: 1, overflow: TextOverflow.ellipsis),
                  Text("${data.device_id}", style: Theme.of(context).textTheme.caption?.copyWith(color: Colors.white70), maxLines: 1, overflow: TextOverflow.ellipsis),
                ],
              )
          ),
        ],
